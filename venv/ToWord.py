#技术实现主要来自jaysonhu,感谢jaysonhu的指点
#pymssql 连接sql server 远程数据库时出现异常，找不到解决方案，故中途改用pyodbc类库
import pyodbc
from win32com.client import Dispatch,constants

#server="tcp:koalaknow-dev.database.windows.net,1433"
#userlogin="koalaknow-sa"
#pwd=""
#db_name="KoalaKnowDev"
...
conn = pyodbc.connect(driver=driver, server=server, user=user, password=password, database=db_name)
